  ...
  return (
    <footer className="footer">
      ...
      <div className="footer-decoration">
        <img src="/footer-plant.svg" alt="" className="footer-plant footer-plant-left" aria-hidden="true" />
        <img src="/footer-plant2.svg" alt="" className="footer-plant footer-plant-right" aria-hidden="true" />
      </div>
